...
export const sendInvitationEmail = async (invitationData: InvitationData) => {
  ...
  const mailOptions = {
    ...
    html: `
      ...
      <a href="https://web-grp5.netlify.app/accept-invitation?projectId=${projectId}&projectName=${encodeURIComponent(projectName)}">Click here</a> to accept or reject the request.</p>
      <br>
